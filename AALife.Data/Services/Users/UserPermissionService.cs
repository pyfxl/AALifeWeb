...
namespace AALife.Data.Services
{
    ...
    /// Permission service
    /// </summary>
    public partial class UserPermissionService : BaseService<UserPermission, Guid>, IUserPermissionService
    {
        #region Constants
        /// <summary>
        /// Key for caching
        ...
        public UserPermissionService(IRepository<UserPermission, Guid> permissionRepository,
