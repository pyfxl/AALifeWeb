...
{
    public partial class UserDeptmentService : BaseService<UserDeptment, Guid>, IUserDeptmentService
    {
        public UserDeptmentService(IRepository<UserDeptment, Guid> repository,
        ...
        public virtual string GetFormattedBreadCrumb(UserDeptment deptment, string separator = "--")
        {
            ...
            var alreadyProcessedPermissionIds = new List<Guid>() { };
            ...
            while (deptment != null && !alreadyProcessedPermissionIds.Contains(deptment.Id)) //prevent circular references
            {
                ...
                deptment = _repository.GetById(deptment.ParentId.GetValueOrDefault());
