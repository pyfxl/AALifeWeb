...
namespace AALife.Data.Services
{
    ...
    public partial class PermissionService : BaseService<PermissionRecord>, IPermissionService
    {
        ...
        public PermissionService(IRepository<PermissionRecord> permissionRecordRepository,
            ...
            : base(permissionRecordRepository, cacheManager, dbContext)
        {
        ...
        public virtual string GetFormattedBreadCrumb(PermissionRecord permission, string separator = "--")
        {
            if (permission == null)
        ...
        /// <returns>true - authorized; otherwise, false</returns>
        public virtual bool Authorize(PermissionRecord permission, UserTable user)
        {
            if (permission == null)
                return false;
        ...
        public virtual bool Authorize(string actionName, string controllerName, string areaName, UserTable user)
        {
            ...
            foreach (var role in userRoles)
                if (role.PermissionRecords.Count(a => a.ActionName == actionName && a.ControllerName == controllerName && a.AreaName == areaName) > 0)
