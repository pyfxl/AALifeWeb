<%@ Page Title="用户资料" Language="C#" MasterPageFile="UserControl/MasterPage.master" AutoEventWireup="true" Inherits="AALife.WebMvc.Web2018.UserAdmin" Codebehind="UserAdmin.aspx.cs" %>
...
<script type="text/javascript">
    $(function () {
        //设置当前菜单
        $(".usermenu .u13").addClass("on");

        //顶部菜单
        var thisname = $(".usermenu .u13").children().text().trim();
