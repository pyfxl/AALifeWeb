<%@ Page Title="后台管理 | 消费列表" Language="C#" MasterPageFile="~/Web2018/Manage/MasterPage.master" AutoEventWireup="true" Inherits="Manage_ItemTable" Codebehind="ItemTable.aspx.cs" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var dataSource = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "/Web2018/api/ItemTable.asmx/GetItemTable",
                        dataType: "json",
