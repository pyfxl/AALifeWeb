<%@ Page Title="后台管理 | 用户列表" Language="C#" MasterPageFile="~/Web2018/Manage/MasterPage.master" AutoEventWireup="true" Inherits="Manage_Home" Codebehind="Home.aspx.cs" %>
        ...
        $(document).ready(function () {
            ...
            var dataSource = new kendo.data.DataSource({
                transport: {
                    ...
                    create: {
                        url: "/Web2018/api/UserTable.asmx/AddUserTable",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    },
                    update: {
                        url: "/Web2018/api/UserTable.asmx/UpdateUserTable",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    },
                    destroy: {
                        url: "/Web2018/api/UserTable.asmx/RemoveUserTable",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    },
            ...
            var dataUserFrom = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "/Web2018/api/UserFrom.asmx/GetUserFrom",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    }
            ...
            var dataWorkDay = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "/Web2018/api/WorkDay.asmx/GetWorkDay",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    }
