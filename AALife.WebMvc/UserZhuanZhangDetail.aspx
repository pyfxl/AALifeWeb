<%@ Page Title="转账明细" Language="C#" MasterPageFile="UserControl/MasterPage.master" AutoEventWireup="true" Inherits="AALife.WebMvc.Web2018.UserZhuanZhangDetail" Codebehind="UserZhuanZhangDetail.aspx.cs" %>
        ...
        <div class="r_usergrid">
            ...
            <table border="0" style="width:924px;" class="tablelist">
                <tr>
                    ...
                    <th style="width:132px;">转账给</th>
                    <th style="width:132px;" class="cellprice">转账金额</th>
                    <th style="width:132px;">转账日期</th>
                    <th style="width:132px;">转账说明</th>
                    <th></th>
                </tr>
            </table>
            <div style="height:430px;">
                <table border="0" style="width:924px;" class="tablelist">
                    ...
                    <tr class='<%# ItemList.Items.Count % 2 == 0 ? "trcolor1" : "trcolor2" %>'>
                        <td style="width:132px;"><%# ItemList.Items.Count + 1 %></td>
                        <td style="width:132px;"><%# Eval("ZhuanZhangFromName") %><asp:HiddenField ID="ZhangFromHid" runat="server" Value='<%# Eval("ZhuanZhangFrom") %>' /></td>
                        <td style="width:132px;"><%# Eval("ZhuanZhangToName") %><asp:HiddenField ID="ZhangToHid" runat="server" Value='<%# Eval("ZhuanZhangTo") %>' /></td>
                        <td style="width:132px;" class="cellprice"><%# Eval("ZhuanZhangMoney", "{0:0.0##}") %><asp:HiddenField ID="ZhangMoneyHid" runat="server" Value='<%# Eval("ZhuanZhangMoney") %>' /></td>
                        <td style="width:132px;"><%# Eval("ZhuanZhangDate", "{0:yyyy-MM-dd}") %></td>
                        <td style="width:132px;"><%# Eval("ZhuanZhangNote") %></td>
