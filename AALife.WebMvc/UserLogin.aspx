<%@ Page Title="网上记账" Language="C#" MasterPageFile="UserControl/MasterPage.master" AutoEventWireup="true" Inherits="AALife.WebMvc.Web2018.UserLogin" Codebehind="UserLogin.aspx.cs" %>
    ...
    <div class="r_login">
        <table border="0" style="width:100%;" class="tableform">
            ...
            <tr>
                ...
                <td class="mbhide" style="width:24%;"><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=944c168235281af2bf07b97f297950d1502ac20a861f261fb0573c78c96abc9a"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="加入AA生活记账QQ群" title="加入AA生活记账QQ群"/></a></td>
            </tr>
            <tr>
                <th>密　码　</th>
                <td><asp:TextBox ID="UserPassword" runat="server" TextMode="Password" MaxLength="12" TabIndex="2"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**&nbsp;&nbsp;&nbsp;<em>( 3-10字符 )</em></td>
                <td class="mbhide"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=67936108&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=1:67936108:7" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></td>
            </tr>
            <tr>
                <th></th>
                <td></td>
