...
(function ($, kendo) {
    var ExtDialog = kendo.ui.Window.extend({
        ...
        _buttonTemplate: kendo.template('<div class="k-ext-dialog-buttons" style="position:absolute; bottom:10px; text-align:center; width:100%;"><div style="display:inline-block;"># $.each (buttons, function (idx, button) { # <button class="k-button" style="margin-right:5px; width:100px;">#= button.name #</button> # }) # </div></div>'),
        _contentTemplate: kendo.template('<div class="k-ext-dialog-content" style="height:#= parseInt(height) - 55 #px; width:100%; overflow:auto;">'),
                ...
                options = $.extend({
                    ...
                    buttons: [{
                        ...
                        click: function (e) {
                            ...
                            deferred.resolve({ button: "OK", selected: selectedDataItems });
                        }
                    }, {
                        name: "取消",
                        click: function (e) {
