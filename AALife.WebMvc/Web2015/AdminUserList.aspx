<%@ Page Language="C#" AutoEventWireup="true" Inherits="AdminUserList" Codebehind="AdminUserList.aspx.cs" %>
                ...
                <asp:GridView ID="AdminList" runat="server" AutoGenerateColumns="False" CssClass="usertable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="头像">
                            <ItemTemplate>
                                <asp:Image ID="UserImageCon" runat="server" CssClass="lazyimg" ImageUrl='/Images/Others/loading.gif' data-original='<%# Eval("UserImage").ToString().StartsWith("http") ? Eval("UserImage") : WebConfiguration.WebSite + "/Images/Users/" + Eval("UserImage") %>' Width="50px" Height="50px" />
