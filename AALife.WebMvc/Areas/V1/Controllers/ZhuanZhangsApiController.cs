...
{
    public class ZhuanZhangsApiController : BaseApiController
    {
        private readonly IZhuanZhangService _zhuanZhangService;
        private readonly ICardService _cardService;

        public ZhuanZhangsApiController(IZhuanZhangService zhuanZhangService,
        ...
        // POST api/<controller>
        public IHttpActionResult Post(Guid id, ZhuanZhangTable model)
        {
            model.LiveOn();
            model.UserId = id;
        ...
        public IHttpActionResult Put(Guid id, ZhuanZhangTable model)
        {
