...
namespace AALife.WebMvc.Areas.V1.Controllers
{
    public class ItemsApiController : BaseApiController
    {
        ...
        public ItemsApiController(ICacheManager cacheManager, 
        ...
        public IHttpActionResult Get([FromUri]jqGrid.DataSourceRequest common, [FromUri]ItemsQuery query)
        {
            ...
            var result = _itemService.GetAllItemByPage(common.page - 1, common.rows, null, null, common.sidx, common.sord, query.userId, query.startDate, query.endDate, query.keyWords);
