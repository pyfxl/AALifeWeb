<%@ Page Title="后台管理 | 用户列表" Language="C#" MasterPageFile="~/Manage2019/MasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Manage_Home" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var dataSource = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "/api/UserTableDapper.asmx/GetUserTable",
                        dataType: "json",
