...
namespace AALife.Core.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        protected virtual void DeletePictureThumbs(Picture picture)
        {
            ...
            var thumbDirectoryPath = CommonHelper.MapPath("~/images/bg/thumbs");
        ...
        {
            var thumbsDirectoryPath = CommonHelper.MapPath("~/images/bg/thumbs");
        ...
        protected virtual string GetThumbUrl(string thumbFileName, string storeLocation = null)
        {
            ...
            var url = storeLocation + "images/bg/thumbs/";
        ...
        {
            return Path.Combine(CommonHelper.MapPath("~/images/bg/"), fileName);
        }
            ...
            string storeLocation = null)
        {
            ...
            if (targetSize == 0)
            {
                string url = (!String.IsNullOrEmpty(storeLocation)
                                 ? storeLocation
                                 : _webHelper.GetStoreLocation())
                                 + "images/bg/" + defaultImageFileName;
                return url;
            }
            else
            {
            ...
            PictureType defaultPictureType = PictureType.Entity)
        {
            ...
            var seoFileName = ""; // = GetPictureSeName(picture.SeoFilename); //just for sure
        ...
        /// <returns>Picture</returns>
        public virtual Picture InsertPicture(byte[] pictureBinary, string mimeType, string fileName, string fileExtName, int fileBytes, bool isNew = true)
        {
        ...
        /// <param name="validateBinary">A value indicating whether to validated provided picture binary</param>
        /// <returns>Picture</returns>
        public virtual Picture UpdatePicture(int pictureId, byte[] pictureBinary, string mimeType, string fileName, string fileExtName, int fileBytes, bool isNew = true)
        {
            mimeType = CommonHelper.EnsureNotNull(mimeType);
            mimeType = CommonHelper.EnsureMaximumLength(mimeType, 20);
