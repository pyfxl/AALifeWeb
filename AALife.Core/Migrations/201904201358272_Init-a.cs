                ...
                c => new
                    {
                        ...
                        ContentType = c.String(maxLength: 40),
                ...
                c => new
                    {
                        ...
                        ShortMessage = c.String(nullable: false, maxLength: 200),
                        FullMessage = c.String(maxLength: 1000),
                        IpAddress = c.String(maxLength: 200),
                        UserId = c.Guid(),
                        PageUrl = c.String(maxLength: 200),
                        ReferrerUrl = c.String(maxLength: 200),
                        CreatedDate = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
